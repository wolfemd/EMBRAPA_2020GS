...
1.  [**Last year's reference panel, without C1 (64K SNP)**]{style="color: DarkBlue"}
...
2.  [**Last year's ref. panel + C1 (include unfiltered C1 data = 64K refpanel SNP)**]{style="color: DarkBlue"}
...
3.  [**Last year's reference panel + C1 (reduce refpanel to sites passing post-impute filter in C1 = 9K SNP)**]{style="color: DarkBlue"}
