...
-   **Genome-wide dosage matrix format for use in R:**
    ...
    -   DCas20\_5360 with standard post-impute filter: [**WARNING:** 0 SNP on Chr. 4] `DosageMatrix_DCas20_5360_REFimputedWithC1unfiltered_PostImputeFiltered.rds`

    -   DCas20\_5360 with "light" post-impute filter: [**WARNING:** 0 SNP on Chr. 4] `DosageMartix_DCas20_5360_REFimputedWithC1unfiltered_LightPostImputeFiltDR2pt3.rds`

**NOTICE:** `REFimputedWithC1unfiltered` is not a good dataset. Chr. 4 is entirely filtered out, including using the "lighter" filter. This emphasizes that it is not a good idea to use poorly imputed haplotypes in the reference panel... evidenced also by the fact that the `REFimputedWithC1filtered` has markers passing filters on all chromosomes.
